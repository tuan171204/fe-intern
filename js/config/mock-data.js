export const coursesData = [
    {
        ...
        schedule: {
            time: "18:45 - 21:45",
            address: "168/6 Bui Thi Xuan Street, Ward 3, Tan Binh District, Ho Chi Minh City, Vietnam",
            schoolDays: [
                "Sessions 1-12: Tuesday, Saturday.",
                "Sessions 13-48: Mondays, Wednesdays, Fridays"
            ]
        },
        contents: [
            {
                title: "Overview, HTML, Photoshop, Chrome Dev Tool",
                details: [
                    "HTML knowledge. Write SEO-standard HTML",
                    "Photoshop",
                    "Chrome Dev Tools"
                ]
            },
            { title: "Redux and the libraries that come with redux", details: ["Redux Toolkit, React-Redux, Redux Thunk/Saga"] },
            { title: "CSS/CSS3", details: ["Flexbox, Grid, Responsive Design"] },
            { title: "Optimization, other hooks, build and deploy the project", details: ["useMemo, useCallback, React.memo, Vercel/Netlify deployment"] },
            { title: "Basic Javascript", details: ["ES6+, Async/Await, Fetch API, Closures"] },
            { title: "Practice the final project of the Shopping Cart course", details: ["Building E-commerce cart with React & Redux"] },
            { title: "Luxestate project report and evaluation", details: ["Code review & presentation"] },
            { title: "Project reporting and evaluation", details: ["Final feedback and grading"] },
            { title: "Advanced HTML. The BEM . Rule", details: ["BEM Naming Convention & Semantic HTML"] },
            { title: "Summarize and share experiences in making CVs", details: ["CV tips & Tech Interview Preparation"] }
        ],
        requirements: [
            "Have a personal laptop. install Photoshop, VSCode software",
            "Minimize school breaks and complete assigned assignments",
